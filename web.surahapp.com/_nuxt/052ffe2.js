            ...
            [3], {
                ...
                1436: function(e, t, n) {
                    ...
                    (function(e) {
                        ...
                        function m(e = Object(c.r)()) {
                            return !("file:" !== f() && "ionic:" !== f() && "capacitor:" !== f() || !e.toLowerCase().match(/iphone|ipad|ipod|android/))
                        }

                        function v(e = Object(c.r)()) {
                            return Object(c.v)() && 11 === (null === document || void 0 === document ? void 0 : document.documentMode) || function(e = Object(c.r)()) {
                        ...
                        function _() {
                            try {
                                const e = self.localStorage,
                                    t = r.s();
                                if (e) return e.setItem(t, "1"), e.removeItem(t), !v() || Object(c.w)()
                            } catch (e) {
                                return y() && Object(c.w)()
                            }
                            return !1
                        ...
                        function I() {
                            return ("http:" === f() || "https:" === f() || Object(c.t)() || m()) && !(Object(c.z)() || Object(c.y)()) && _() && !y()
                        }

                        function w() {
                            return m() && "undefined" != typeof document
                        }
                        const T = {
                                LOCAL: "local",
                                NONE: "none",
                        ...
                        async function R(e) {
                            ...
                            const t = O(),
                                n = r.w(E, e.config.apiKey, e.name);
                        ...
                        class A {
                            constructor() {
                                this.browserResolver = r.t(r.A), this.cordovaResolver = r.t(r.F), this.underlyingResolver = null, this._redirectPersistence = r.B, this._completeRedirectFn = r.u, this._overrideRedirectResult = r.v
                            }
                            async _initialize(e) {
                        ...
                        function N(object) {
                            const {
                                _tokenResponse: e
                            } = object instanceof c.c ? object.customData : object;
                            if (!e) return null;
                            if (!(object instanceof c.c) && "temporaryProof" in e && "phoneNumber" in e) return r.i.credentialFromResult(object);
                            const t = e.providerId;
                            if (!t || t === r.k.PASSWORD) return null;
                            let n;
                            switch (t) {
                                case r.k.GOOGLE:
                                    n = r.f;
                                ...
                                default:
                                    ...
                                    return c || d || o || l ? l ? t.startsWith("saml.") ? r.m._create(t, l) : r.g._fromParams({
                                        providerId: t,
                                        signInMethod: t,
                                        pendingToken: l,
                                        idToken: o,
                                        accessToken: c
                                    }) : new r.h(t).credential({
                                        idToken: o,
                                        accessToken: c,
                                        rawNonce: h
                                    }) : null
                            }
                            return object instanceof c.c ? n.credentialFromError(object) : n.credentialFromResult(object)
                        }

                        function C(e, t) {
                            return t.catch((t => {
                                throw t instanceof c.c && function(e, t) {
                                    var n;
                                    const o = null === (n = t.customData) || void 0 === n ? void 0 : n._tokenResponse;
                                    if ("auth/multi-factor-auth-required" === (null == t ? void 0 : t.code)) t.resolver = new D(e, r.K(e, t));
                                    else if (o) {
                                        const e = N(t),
                                            n = t;
                                        e && (n.credential = e, n.tenantId = o.tenantId || void 0, n.email = o.email || void 0, n.phoneNumber = o.phoneNumber || void 0)
                                    }
                                }(e, t), t
                            })).then((e => {
                        ...
                        class D {
                            ...
                            resolveSignIn(e) {
                                return C(P(this.auth), this.resolver.resolveSignIn(e))
                            }
                        }
                        class M {
                            constructor(e) {
                                this._delegate = e, this.multiFactor = r.T(e)
                            }
                            static getOrCreate(e) {
                                return M.USER_MAP.has(e) || M.USER_MAP.set(e, new M(e)), M.USER_MAP.get(e)
                            }
                            delete() {
                            ...
                            async linkWithCredential(e) {
                                return C(this.auth, r.P(this._delegate, e))
                            }
                            async linkWithPhoneNumber(e, t) {
                                return L(this.auth, r.Q(this._delegate, e, t))
                            }
                            async linkWithPopup(e) {
                                return C(this.auth, r.R(this._delegate, e, A))
                            }
                            async linkWithRedirect(e) {
                                return await R(r.q(this.auth)), r.S(this._delegate, e, A)
                            }
                        ...
                        class j {
                            constructor(e, t) {
                                ...
                                const o = "undefined" != typeof window ? A : void 0;
                                this._delegate = t.initialize({
                                    options: {
                                        persistence: x(n, e.name),
                            ...
                            get currentUser() {
                                return this._delegate.currentUser ? M.getOrCreate(this._delegate.currentUser) : null
                            }
                            get languageCode() {
                            ...
                            applyActionCode(code) {
                                return r.y(this._delegate, code)
                            }
                            checkActionCode(code) {
                                return r.C(this._delegate, code)
                            }
                            confirmPasswordReset(code, e) {
                                return r.D(this._delegate, code, e)
                            }
                            async createUserWithEmailAndPassword(e, t) {
                                return C(this._delegate, r.G(this._delegate, e, t))
                            }
                            ...
                            async getRedirectResult() {
                                U(I(), this._delegate, "operation-not-supported-in-this-environment");
                                const e = await r.L(this._delegate, A);
                                return e ? C(this._delegate, Promise.resolve(e)) : {
                                    credential: null,
                                    user: null
                                }
                            }
                            ...
                            onAuthStateChanged(e, t, n) {
                                ...
                                return this._delegate.onAuthStateChanged(r, o, c)
                            }
                            onIdTokenChanged(e, t, n) {
                                ...
                                return this._delegate.onIdTokenChanged(r, o, c)
                            }
                            ...
                            async setPersistence(e) {
                                let t;
                                switch (function(e, t) {
                                    k(Object.values(T).includes(t), e, "invalid-persistence-type"), Object(c.z)() ? k(t !== T.SESSION, e, "unsupported-persistence-type") : Object(c.y)() ? k(t === T.NONE, e, "unsupported-persistence-type") : y() ? k(t === T.NONE || t === T.LOCAL && Object(c.w)(), e, "unsupported-persistence-type") : k(t === T.NONE || _(), e, "unsupported-persistence-type")
                                }(this._delegate, e), e) {
                                    case T.SESSION:
                                        t = r.B;
                                        break;
                                    case T.LOCAL:
                                        t = await r.t(r.N)._isAvailable() ? r.N : r.z;
                                        break;
                                    case T.NONE:
                                        t = r.M;
                                        break;
                            ...
                            signInWithPhoneNumber(e, t) {
                                return L(this._delegate, r.gb(this._delegate, e, t))
                            }
                            async signInWithPopup(e) {
                                return U(I(), this._delegate, "operation-not-supported-in-this-environment"), C(this._delegate, r.hb(this._delegate, e, A))
                            }
                            async signInWithRedirect(e) {
                                return U(I(), this._delegate, "operation-not-supported-in-this-environment"), await R(this._delegate), r.ib(this._delegate, e, A)
                            }
                            updateCurrentUser(e) {
                                return this._delegate.updateCurrentUser(e)
                            }
                            verifyPasswordResetCode(code) {
                                return r.pb(this._delegate, code)
                            }
                            unwrap() {
                        ...
                        function x(e, t) {
                            ...
                            if ("undefined" == typeof self || n.includes(r.N) || n.push(r.N), "undefined" != typeof window)
                                for (const e of [r.z, r.B]) n.includes(e) || n.push(e);
                            return n.includes(r.M) || n.push(r.M), n
                        }
                        j.Persistence = T;
                        class V {
                            constructor() {
                                this.providerId = "phone", this._delegate = new r.i(P(t.a.auth()))
                            }
                        ...
                        V.PHONE_SIGN_IN_METHOD = r.i.PHONE_SIGN_IN_METHOD, V.PROVIDER_ID = r.i.PROVIDER_ID;
                        const W = r.p;
                        class z {
                            constructor(e, n, o = t.a.app()) {
                                var c;
                                W(null === (c = o.options) || void 0 === c ? void 0 : c.apiKey, "invalid-api-key", {
                                    appName: o.name
                                }), this._delegate = new r.l(e, n, o.auth()), this.type = this._delegate.type
                            }
                            clear() {
                        ...
                        const H = "auth-compat";
                        var G;
                        (G = t.a).INTERNAL.registerComponent(new o.a(H, (e => {
                            ...
                            AuthCredential: r.b,
                            Error: c.c
                        }).setInstantiationMode("LAZY").setMultipleInstances(!1)), G.registerVersion(d, l)
                    }).call(this, n(88))
                },
                1525: function(e, t, n) {
                        "use strict";
                        ...
                        const v = function() {
                            ...
                            _ = m,
                            y = new r.b("auth", "Firebase", {
                                "dependent-sdk-initialized-before-auth": "Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."
                            }),
                            I = new c.b("@firebase/auth");

                        function w(e, ...t) {
                            I.logLevel <= c.a.ERROR && I.error(`Auth (${o.SDK_VERSION}): ${e}`, ...t)
                        }
                        ...
                        function E(e, code, t) {
                            ...
                            return new r.b("auth", "Firebase", n).create(code, {
                                appName: e.name
                            })
                        }

                        function R(e, object, t) {
                            if (!(object instanceof t)) throw t.name !== object.constructor.name && T(e, "argument-error"), E(e, "argument-error", `Type of ${object.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)
                        }
                        ...
                        function O(e, ...t) {
                            if ("string" != typeof e) {
                                const code = t[0],
                                    n = [...t.slice(1)];
                                return n[0] && (n[0].appName = e.name), e._errorFactory.create(code, ...n)
                            }
                            return y.create(e, ...t)
                        }
                        ...
                        function C(e) {
                            ...
                            let t = N.get(e);
                            return t ? (P(t instanceof e, "Instance stored in cache mismatched with class"), t) : (t = new e, N.set(e, t), t)
                        }
                        ...
                        class U {
                            constructor(e, t) {
                                this.shortDelay = e, this.longDelay = t, P(t > e, "Short delay should be less than long delay!"), this.isMobile = Object(r.x)() || Object(r.z)()
                            }
                            get() {
                                return "undefined" != typeof navigator && navigator && "onLine" in navigator && "boolean" == typeof navigator.onLine && (D() || Object(r.t)() || "connection" in navigator) && !navigator.onLine ? Math.min(5e3, this.shortDelay) : this.isMobile ? this.longDelay : this.shortDelay
                            }
                        }
                        ...
                        function j(e, path) {
                            ...
                            return path ? `${t}${path.startsWith("/")?path.slice(1):path}` : t
                        }
                        class F {
                            ...
                            static fetch() {
                                return this.fetchImpl ? this.fetchImpl : "undefined" != typeof self && "fetch" in self ? self.fetch : void A("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
                            }
                            static headers() {
                                return this.headersImpl ? this.headersImpl : "undefined" != typeof self && "Headers" in self ? self.Headers : void A("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
                            }
                            static response() {
                                return this.responseImpl ? this.responseImpl : "undefined" != typeof self && "Response" in self ? self.Response : void A("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
                            }
                        }
                        const x = {
                        ...
                        async function z(e, t, path, n, o = {}) {
                            return H(e, o, (async () => {
                                ...
                                const c = Object(r.B)(Object.assign({
                                        key: e.config.apiKey
                                    }, o)).slice(1),
                                    d = await e._getAdditionalHeaders();
                                return d["Content-Type"] = "application/json", e.languageCode && (d["X-Firebase-Locale"] = e.languageCode), F.fetch()(K(e, e.config.apiHost, path, c), Object.assign({
                                    method: t,
                                    headers: d,
                        ...
                        async function H(e, t, n) {
                            ...
                            const o = Object.assign(Object.assign({}, x), t);
                            try {
                                const t = new B(e),
                                    r = await Promise.race([n(), t.promise]);
                                t.clearNetworkTimeout();
                                const c = await r.json();
                                if ("needConfirmation" in c) throw J(e, "account-exists-with-different-credential", c);
                                if (r.ok && !("errorMessage" in c)) return c; {
                                    const t = r.ok ? c.errorMessage : c.error.message,
                                        [n, d] = t.split(" : ");
                                    if ("FEDERATED_USER_ID_ALREADY_LINKED" === n) throw J(e, "credential-already-in-use", c);
                                    if ("EMAIL_EXISTS" === n) throw J(e, "email-already-in-use", c);
                                    if ("USER_DISABLED" === n) throw J(e, "user-disabled", c);
                                    const l = o[n] || n.toLowerCase().replace(/[_\s]+/g, "-");
                                    if (d) throw E(e, l, d);
                                    T(e, l)
                                }
                            } catch (t) {
                                if (t instanceof r.c) throw t;
                                T(e, "network-request-failed")
                            }
                        }
                        async function G(e, t, path, n, r = {}) {
                            const o = await z(e, t, path, n, r);
                            return "mfaPendingCredential" in o && T(e, "multi-factor-auth-required", {
                                _serverResponse: o
                            }), o
                        }

                        function K(e, t, path, n) {
                            const base = `${t}${path}?${n}`;
                            return e.config.emulator ? j(e.config, base) : `${e.config.apiScheme}://${base}`
                        }
                        class B {
                            constructor(e) {
                                this.auth = e, this.timer = null, this.promise = new Promise(((e, t) => {
                                    this.timer = setTimeout((() => t(k(this.auth, "network-request-failed"))), V.get())
                                }))
                            }
                            clearNetworkTimeout() {
                        ...
                        function X(e) {
                            const [t, n, o] = e.split(".");
                            if (void 0 === t || void 0 === n || void 0 === o) return w("JWT malformed, contained fewer than 3 sections"), null;
                            try {
                                const e = Object(r.e)(n);
                                return e ? JSON.parse(e) : (w("Failed to decode base64 JWT payload"), null)
                            } catch (e) {
                        ...
                        async function Q(e, t, n = !1) {
                            ...
                            try {
                                ...
                                throw t instanceof r.c && function({
                                    code: code
                                }) {
                        ...
                        async function te(e) {
                            ...
                            const n = e.auth,
                                ...
                                o = await Q(e, async function(e, t) {
                                    return z(e, "POST", "/v1/accounts:lookup", t)
                                }(n, {
                                    idToken: r
                                }));
                            S(null == o ? void 0 : o.users.length, n, "internal-error");
                            const c = o.users[0];
                            e._notifyReloadListener(c);
                            const l = (null === (t = c.providerUserInfo) || void 0 === t ? void 0 : t.length) ? c.providerUserInfo.map((e => {
                                var {
                                    providerId: t
                                } = e, n = d(e, ["providerId"]);
                                return {
                            ...
                            const h = (f = e.providerData, m = l, [...f.filter((e => !m.some((t => t.providerId === e.providerId)))), ...m]);
                            var f, m;
                            const v = e.isAnonymous,
                                _ = !(e.email && c.passwordHash || (null == h ? void 0 : h.length)),
                                y = !!v && _,
                                I = {
                                    uid: c.localId,
                                    ...
                                    providerData: h,
                                    metadata: new ee(c.createdAt, c.lastLoginAt),
                                    isAnonymous: y
                                };
                            Object.assign(e, I)
                        }
                        class ne {
                            ...
                            updateFromServerResponse(e) {
                                S(e.idToken, "internal-error"), S(void 0 !== e.idToken, "internal-error"), S(void 0 !== e.refreshToken, "internal-error");
                                const t = "expiresIn" in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : function(e) {
                                    const t = X(e);
                                    return S(t, "internal-error"), S(void 0 !== t.exp, "internal-error"), S(void 0 !== t.iat, "internal-error"), Number(t.exp) - Number(t.iat)
                                }(e.idToken);
                                this.updateTokensAndExpiration(e.idToken, e.refreshToken, t)
                            }
                            async getToken(e, t = !1) {
                                return S(!this.accessToken || this.refreshToken, e, "user-token-expired"), t || !this.accessToken || this.isExpired ? this.refreshToken ? (await this.refresh(e, this.refreshToken), this.accessToken) : null : this.accessToken
                            }
                            clearRefreshToken() {
                            ...
                            async refresh(e, t) {
                                const {
                                    ...
                                    const n = await H(e, {}, (async () => {
                                        const body = Object(r.B)({
                                            ...
                                            c = K(e, n, "/v1/token", `key=${o}`),
                                            d = await e._getAdditionalHeaders();
                                        return d["Content-Type"] = "application/x-www-form-urlencoded", F.fetch()(c, {
                                            method: "POST",
                                            headers: d,
                                            body: body
                                        })
                                ...
                                this.updateTokensAndExpiration(n, o, Number(c))
                            }
                            updateTokensAndExpiration(e, t, n) {
                                this.refreshToken = t || null, this.accessToken = e || null, this.expirationTime = Date.now() + 1e3 * n
                            }
                            static fromJSON(e, object) {
                                const {
                                    refreshToken: t,
                                    accessToken: n,
                                    expirationTime: r
                                } = object, o = new ne;
                                return t && (S("string" == typeof t, "internal-error", {
                                    appName: e
                                }), o.refreshToken = t), n && (S("string" == typeof n, "internal-error", {
                                    appName: e
                                }), o.accessToken = n), r && (S("number" == typeof r, "internal-error", {
                                    appName: e
                        ...
                        function ie(e, t) {
                            S("string" == typeof e || void 0 === e, "internal-error", {
                                appName: t
                            })
                        }
                        class re {
                            constructor(e) {
                                var {
                                    ...
                                    auth: n,
                                    stsTokenManager: r
                                } = e, o = d(e, ["uid", "auth", "stsTokenManager"]);
                                this.providerId = "firebase", this.proactiveRefresh = new Z(this), this.reloadUserInfo = null, this.reloadListener = null, this.uid = t, this.auth = n, this.stsTokenManager = r, this.accessToken = r.accessToken, this.displayName = o.displayName || null, this.email = o.email || null, this.emailVerified = o.emailVerified || !1, this.phoneNumber = o.phoneNumber || null, this.photoURL = o.photoURL || null, this.isAnonymous = o.isAnonymous || !1, this.tenantId = o.tenantId || null, this.providerData = o.providerData ? [...o.providerData] : [], this.metadata = new ee(o.createdAt || void 0, o.lastLoginAt || void 0)
                            }
                            async getIdToken(e) {
                            ...
                            getIdTokenResult(e) {
                                return async function(e, t = !1) {
                                    const n = Object(r.q)(e),
                                        o = await n.getIdToken(t),
                                        c = X(o);
                                    S(c && c.exp && c.auth_time && c.iat, n.auth, "internal-error");
                                    const d = "object" == typeof c.firebase ? c.firebase : void 0,
                                        l = null == d ? void 0 : d.sign_in_provider;
                                    return {
                                        claims: c,
                                        token: o,
                                        authTime: $(Y(c.auth_time)),
                                        issuedAtTime: $(Y(c.iat)),
                                        expirationTime: $(Y(c.exp)),
                                        signInProvider: l || null,
                                        signInSecondFactor: (null == d ? void 0 : d.sign_in_second_factor) || null
                                    }
                                }(this, e)
                            }
                            reload() {
                            ...
                            _clone(e) {
                                return new re(Object.assign(Object.assign({}, this), {
                                    auth: e,
                                    stsTokenManager: this.stsTokenManager._clone()
                                }))
                            }
                            _onReload(e) {
                                S(!this.reloadListener, this.auth, "internal-error"), this.reloadListener = e, this.reloadUserInfo && (this._notifyReloadListener(this.reloadUserInfo), this.reloadUserInfo = null)
                            }
                            ...
                            async delete() {
                                ...
                                return await Q(this, async function(e, t) {
                                    return z(e, "POST", "/v1/accounts:delete", t)
                                }(this.auth, {
                                    idToken: e
                            ...
                            static _fromJSON(e, object) {
                                var t, n, r, o, c, d, l, h;
                                const f = null !== (t = object.displayName) && void 0 !== t ? t : void 0,
                                    m = null !== (n = object.email) && void 0 !== n ? n : void 0,
                                    v = null !== (r = object.phoneNumber) && void 0 !== r ? r : void 0,
                                    _ = null !== (o = object.photoURL) && void 0 !== o ? o : void 0,
                                    y = null !== (c = object.tenantId) && void 0 !== c ? c : void 0,
                                    I = null !== (d = object._redirectEventId) && void 0 !== d ? d : void 0,
                                    w = null !== (l = object.createdAt) && void 0 !== l ? l : void 0,
                                    T = null !== (h = object.lastLoginAt) && void 0 !== h ? h : void 0,
                                    {
                                        uid: k,
                                        emailVerified: E,
                                        isAnonymous: R,
                                ...
                                S(k && A, e, "internal-error");
                                const P = ne.fromJSON(this.name, A);
                                S("string" == typeof k, e, "internal-error"), ie(f, e.name), ie(m, e.name), S("boolean" == typeof E, e, "internal-error"), S("boolean" == typeof R, e, "internal-error"), ie(v, e.name), ie(_, e.name), ie(y, e.name), ie(I, e.name), ie(w, e.name), ie(T, e.name);
                                const N = new re({
                                    uid: k,
                                    auth: e,
                                    email: m,
                                ...
                                return O && Array.isArray(O) && (N.providerData = O.map((e => Object.assign({}, e)))), I && (N._redirectEventId = I), N
                            }
                        ...
                        class ce {
                            constructor(e, t, n) {
                                ...
                                this.fullUserKey = ae(this.userKey, r.apiKey, o), this.fullPersistenceKey = ae("persistence", r.apiKey, o), this.boundEventHandler = t._onStorageEvent.bind(t), this.persistence._addListener(this.fullUserKey, this.boundEventHandler)
                            }
                            setCurrentUser(e) {
                            ...
                            static async create(e, t, n = "authUser") {
                                if (!t.length) return new ce(C(oe), e, n);
                                const r = (await Promise.all(t.map((async e => {
                                    if (await e._isAvailable()) return e
                                })))).filter((e => e));
                                let o = r[0] || C(oe);
                                const c = ae(n, e.config.apiKey, e.name);
                                let d = null;
                                for (const n of t) try {
                                    const t = await n._get(c);
                                    if (t) {
                                        const r = re._fromJSON(e, t);
                                        n !== o && (d = r), o = n;
                                        break
                                    }
                                } catch (e) {}
                                const l = r.filter((p => p._shouldAllowMigration));
                                return o._shouldAllowMigration && l.length ? (o = l[0], d && await o._set(c, d.toJSON()), await Promise.all(t.map((async e => {
                                    if (e !== o) try {
                                        await e._remove(c)
                                    } catch (e) {}
                                }))), new ce(o, e, n)) : new ce(o, e, n)
                            }
                        }
                        ...
                        function de(e = Object(r.r)()) {
                            return /firefox\//i.test(e)
                        }

                        function le(e = Object(r.r)()) {
                            const t = e.toLowerCase();
                            return t.includes("safari/") && !t.includes("chrome/") && !t.includes("crios/") && !t.includes("android")
                        }

                        function he(e = Object(r.r)()) {
                            return /crios\//i.test(e)
                        }

                        function pe(e = Object(r.r)()) {
                            return /iemobile/i.test(e)
                        }

                        function fe(e = Object(r.r)()) {
                            return /android/i.test(e)
                        }

                        function me(e = Object(r.r)()) {
                            return /blackberry/i.test(e)
                        }

                        function ge(e = Object(r.r)()) {
                            return /webos/i.test(e)
                        }

                        function ve(e = Object(r.r)()) {
                            return /iphone|ipad|ipod/i.test(e) || /macintosh/i.test(e) && /mobile/i.test(e)
                        }

                        function _e(e = Object(r.r)()) {
                            return ve(e) || fe(e) || ge(e) || me(e) || /windows phone/i.test(e) || pe(e)
                        }
                        ...
                        function ye(e, t = []) {
                            ...
                            return `${n}/JsCore/${o.SDK_VERSION}/${c}`
                        }
                        class Ie {
                            constructor(e) {
                        ...
                        class we {
                            ...
                            async initializeCurrentUser(e) {
                                ...
                                if (e && this.config.authDomain) {
                                    ...
                                    const n = null === (t = this.redirectUser) || void 0 === t ? void 0 : t._redirectEventId,
                                        c = null == r ? void 0 : r._redirectEventId,
                                        d = await this.tryRedirectSignIn(e);
                                    n && n !== c || !(null == d ? void 0 : d.user) || (r = d.user, o = !0)
                                }
                                ...
                                return S(this._popupRedirectResolver, this, "argument-error"), await this.getOrInitRedirectPersistenceManager(), this.redirectUser && this.redirectUser._redirectEventId === r._redirectEventId ? this.directlySetCurrentUser(r) : this.reloadAndSetCurrentUserOrClear(r)
                            }
                            ...
                            async getOrInitRedirectPersistenceManager(e) {
                                if (!this.redirectPersistenceManager) {
                                    ...
                                    S(t, this, "argument-error"), this.redirectPersistenceManager = await ce.create(this, [C(t._redirectPersistence)], "redirectUser"), this.redirectUser = await this.redirectPersistenceManager.getCurrentUser()
                                }
                            ...
                            registerStateListener(e, t, n, r) {
                                ...
                                return S(c, this, "internal-error"), c.then((() => o(this.currentUser))), "function" == typeof t ? e.addObserver(t, n, r) : e.addObserver(t)
                            }
                            ...
                            _logFramework(e) {
                                e && !this.frameworks.includes(e) && (this.frameworks.push(e), this.frameworks.sort(), this.clientVersion = ye(this.config.clientPlatform, this._getFrameworks()))
                            }
                            _getFrameworks() {
                        ...
                        class Te {
                            constructor(e) {
                                this.auth = e, this.observer = null, this.addObserver = Object(r.i)((e => this.observer = e))
                            }
                            get next() {
                        ...
                        function ke(e, t, n) {
                            ...
                            const o = !!(null == n ? void 0 : n.disableWarnings),
                                c = Ee(t),
                                {
                                    host: d,
                                    port: l
                        ...
                        async function Se(e, t) {
                            return z(e, "POST", "/v1/accounts:resetPassword", W(e, t))
                        }
                        async function Ae(e, t) {
                            return z(e, "POST", "/v1/accounts:update", t)
                        }
                        async function Pe(e, t) {
                            return z(e, "POST", "/v1/accounts:sendOobCode", W(e, t))
                        }
                        class Ne extends Oe {
                                ...
                                switch (this.signInMethod) {
                                    case "password":
                                        return async function(e, t) {
                                            return G(e, "POST", "/v1/accounts:signInWithPassword", W(e, t))
                                        }(e, {
                                            returnSecureToken: !0,
                                            email: this._email,
                                            password: this._password
                                    ...
                                    case "emailLink":
                                        return async function(e, t) {
                                            return G(e, "POST", "/v1/accounts:signInWithEmailLink", W(e, t))
                                        }(e, {
                                            email: this._email,
                        ...
                        async function Ce(e, t) {
                            return G(e, "POST", "/v1/accounts:signInWithIdp", W(e, t))
                        }
                        class Le extends Oe {
                            constructor() {
                            ...
                            static _fromParams(e) {
                                const t = new Le(e.providerId, e.signInMethod);
                                return e.idToken || e.accessToken ? (e.idToken && (t.idToken = e.idToken), e.accessToken && (t.accessToken = e.accessToken), e.nonce && !e.pendingToken && (t.nonce = e.nonce), e.pendingToken && (t.pendingToken = e.pendingToken)) : e.oauthToken && e.oauthTokenSecret ? (t.accessToken = e.oauthToken, t.secret = e.oauthTokenSecret) : T("argument-error"), t
                            }
                            toJSON() {
                                return {
                            ...
                            static fromJSON(e) {
                                const t = "string" == typeof e ? JSON.parse(e) : e,
                                    ...
                                    o = d(t, ["providerId", "signInMethod"]);
                                if (!n || !r) return null;
                                const c = new Le(n, r);
                                return c.idToken = o.idToken || void 0, c.accessToken = o.accessToken || void 0, c.secret = o.secret, c.nonce = o.nonce, c.pendingToken = o.pendingToken || null, c
                            }
                            _getIdTokenResponse(e) {
                                return Ce(e, this.buildRequest())
                            }
                            _linkToIdToken(e, t) {
                                const n = this.buildRequest();
                                return n.idToken = t, Ce(e, n)
                            }
                            _getReauthenticationResolver(e) {
                                const t = this.buildRequest();
                                return t.autoCreate = !1, Ce(e, t)
                            }
                            buildRequest() {
                                const e = {
                                ...
                                if (this.pendingToken) e.pendingToken = this.pendingToken;
                                    ...
                                    const t = {};
                                    this.idToken && (t.id_token = this.idToken), this.accessToken && (t.access_token = this.accessToken), this.secret && (t.oauth_token_secret = this.secret), t.providerId = this.providerId, this.nonce && !this.pendingToken && (t.nonce = this.nonce), e.postBody = Object(r.B)(t)
                                }
                                return e
                            }
                        }
                        ...
                        class Me extends Oe {
                            ...
                            _getIdTokenResponse(e) {
                                return async function(e, t) {
                                    return G(e, "POST", "/v1/accounts:signInWithPhoneNumber", W(e, t))
                                }(e, this._makeVerificationRequest())
                            }
                            _linkToIdToken(e, t) {
                                return async function(e, t) {
                                    const n = await G(e, "POST", "/v1/accounts:signInWithPhoneNumber", W(e, t));
                            ...
                            _getReauthenticationResolver(e) {
                                return async function(e, t) {
                                    return G(e, "POST", "/v1/accounts:signInWithPhoneNumber", W(e, Object.assign(Object.assign({}, t), {
                                        operation: "REAUTH"
                                    })), De)
                                }(e, this._makeVerificationRequest())
                            }
                        ...
                        class Ue {
                            constructor(e) {
                                var t, n, o, c, d, l;
                                const h = Object(r.C)(Object(r.l)(e)),
                                    f = null !== (t = h.apiKey) && void 0 !== t ? t : null,
                                    code = null !== (n = h.oobCode) && void 0 !== n ? n : null,
                                    m = function(e) {
                                        switch (e) {
                                            case "recoverEmail":
                                    ...
                                    }(null !== (o = h.mode) && void 0 !== o ? o : null);
                                S(f && code && m, "argument-error"), this.apiKey = f, this.operation = m, this.code = code, this.continueUrl = null !== (c = h.continueUrl) && void 0 !== c ? c : null, this.languageCode = null !== (d = h.languageCode) && void 0 !== d ? d : null, this.tenantId = null !== (l = h.tenantId) && void 0 !== l ? l : null
                            }
                            static parseLink(link) {
                                const e = function(e) {
                                    const link = Object(r.C)(Object(r.l)(e)).link,
                                        t = link ? Object(r.C)(Object(r.l)(link)).deep_link_id : null,
                                        n = Object(r.C)(Object(r.l)(e)).deep_link_id;
                                    return (n ? Object(r.C)(Object(r.l)(n)).link : null) || n || t || link || e
                                }(link);
                                try {
                                    return new Ue(e)
                                } catch (e) {
                        ...
                        class je {
                            constructor() {
                                this.providerId = je.PROVIDER_ID
                            }
                            static credential(e, t) {
                                return Ne._fromEmailAndPassword(e, t)
                            }
                            static credentialWithLink(e, t) {
                                const n = Ue.parseLink(t);
                                return S(n, "argument-error"), Ne._fromEmailAndCode(e, n.code, n.tenantId)
                            }
                        }
                        je.PROVIDER_ID = "password", je.EMAIL_PASSWORD_SIGN_IN_METHOD = "password", je.EMAIL_LINK_SIGN_IN_METHOD = "emailLink";
                        class Fe {
                            constructor(e) {
                        ...
                        class Ve extends xe {
                            static credentialFromJSON(e) {
                                const t = "string" == typeof e ? JSON.parse(e) : e;
                                return S("providerId" in t && "signInMethod" in t, "argument-error"), Le._fromParams(t)
                            }
                            credential(e) {
                            ...
                            _credential(e) {
                                return S(e.idToken || e.accessToken, "argument-error"), Le._fromParams(Object.assign(Object.assign({}, e), {
                                    providerId: this.providerId,
                            ...
                            static oauthCredentialFromTaggedObject({
                                ...
                                if (!(n || r || t || o)) return null;
                                if (!d) return null;
                                try {
                                    return new Ve(d)._credential({
                                        idToken: t,
                                        accessToken: n,
                                        nonce: c,
                                        pendingToken: o
                        ...
                        qe.FACEBOOK_SIGN_IN_METHOD = "facebook.com", qe.PROVIDER_ID = "facebook.com";
                        class We extends xe {
                            constructor() {
                        ...
                        We.GOOGLE_SIGN_IN_METHOD = "google.com", We.PROVIDER_ID = "google.com";
                        class ze extends xe {
                            constructor() {
                                super("github.com")
                            }
                        ...
                        class He extends Oe {
                            ...
                            static fromJSON(e) {
                                ...
                                return n && r && o && n === r ? new He(n, o) : null
                            }
                            static _create(e, t) {
                                return new He(e, t)
                            }
                        ...
                        class Ge extends Fe {
                            ...
                            static credentialFromResult(e) {
                                return Ge.samlCredentialFromTaggedObject(e)
                            }
                            static credentialFromError(e) {
                                return Ge.samlCredentialFromTaggedObject(e.customData || {})
                            }
                            static credentialFromJSON(e) {
                                const t = He.fromJSON(e);
                        ...
                        async function Be(e, t) {
                            return G(e, "POST", "/v1/accounts:signUp", W(e, t))
                        }
                        ...
                        class Je {
                            ...
                            static async _fromIdTokenResponse(e, t, n, r = !1) {
                                const o = await re._fromIdTokenResponse(e, n, r),
                                    c = $e(n);
                                return new Je({
                                    user: o,
                                    providerId: c,
                        ...
                        async function Ye(e) {
                            ...
                            const r = await Be(n, {
                                ...
                                o = await Je._fromIdTokenResponse(n, "signIn", r, !0);
                            return await n._updateCurrentUser(o.user), o
                        }
                        class Xe extends r.c {
                            constructor(e, t, n, r) {
                                var o;
                                super(t.code, t.message), this.operationType = n, this.user = r, Object.setPrototypeOf(this, Xe.prototype), this.customData = {
                                    appName: e.name,
                        ...
                        function Qe(e, t, n, r) {
                            return ("reauthenticate" === t ? n._getReauthenticationResolver(e) : n._getIdTokenResponse(e)).catch((n => {
                                if ("auth/multi-factor-auth-required" === n.code) throw Xe._fromErrorAndOperation(e, n, t, r);
                                throw n
                            }))
                        }
                        ...
                        async function et(e, t) {
                            ...
                            return n.providerData = n.providerData.filter((e => c.has(e.providerId))), c.has("phone") || (n.phoneNumber = null), await n.auth._persistUserIfCurrent(n), n
                        }
                        async function tt(e, t, n = !1) {
                            const r = await Q(e, t._linkToIdToken(e.auth, await e.getIdToken()), n);
                            return Je._forOperation(e, "link", r)
                        }
                        async function nt(e, t, n) {
                            await te(t);
                            const code = !1 === e ? "provider-already-linked" : "no-such-provider";
                            S(Ze(t.providerData).has(n) === e, t.auth, code)
                        }
                        async function it(e, t, n = !1) {
                            ...
                            try {
                                const c = await Q(e, Qe(r, o, t, e), n);
                                S(c.idToken, r, "internal-error");
                                const d = X(c.idToken);
                                S(d, r, "internal-error");
                                const {
                                    sub: l
                                } = d;
                                return S(e.uid === l, r, "user-mismatch"), Je._forOperation(e, o, c)
                            } catch (e) {
                                throw "auth/user-not-found" === (null == e ? void 0 : e.code) && T(r, "user-mismatch"), e
                            }
                        }
                        async function st(e, t, n = !1) {
                            const r = "signIn",
                                o = await Qe(e, r, t),
                                c = await Je._fromIdTokenResponse(e, r, o);
                            return n || await e._updateCurrentUser(c.user), c
                        }
                        ...
                        async function at(e, t) {
                            const n = Object(r.q)(e);
                            return await nt(!1, n, t.providerId), tt(n, t)
                        }
                        async function ct(e, t) {
                            return it(Object(r.q)(e), t)
                        }
                        async function ut(e, t) {
                            const n = be(e),
                                r = await async function(e, t) {
                                    return G(e, "POST", "/v1/accounts:signInWithCustomToken", W(e, t))
                                }(n, {
                                    token: t,
                                    returnSecureToken: !0
                                }),
                                o = await Je._fromIdTokenResponse(n, "signIn", r);
                            return await n._updateCurrentUser(o.user), o
                        }
                        class lt {
                            constructor(e, t) {
                            ...
                            static _fromServerResponse(e, t) {
                                return "phoneInfo" in t ? ht._fromServerResponse(e, t) : T(e, "internal-error")
                            }
                        }
                        class ht extends lt {
                            constructor(e) {
                        ...
                        async function gt(e, t) {
                            await async function(e, t) {
                                return z(e, "POST", "/v1/accounts:update", W(e, t))
                            }(Object(r.q)(e), {
                                oobCode: t
                            })
                        }
                        async function vt(e, t) {
                            const n = Object(r.q)(e),
                                ...
                                c = o.requestType;
                            switch (S(c, n, "internal-error"), c) {
                                case "EMAIL_SIGNIN":
                                    break;
                                case "VERIFY_AND_CHANGE_EMAIL":
                                    S(o.newEmail, n, "internal-error");
                                    break;
                                case "REVERT_SECOND_FACTOR_ADDITION":
                                    S(o.mfaInfo, n, "internal-error");
                                default:
                                    S(o.email, n, "internal-error")
                            }
                            let d = null;
                            return o.mfaInfo && (d = lt._fromServerResponse(be(n), o.mfaInfo)), {
                                data: {
                                    email: ("VERIFY_AND_CHANGE_EMAIL" === o.requestType ? o.newEmail : o.email) || null,
                                    previousEmail: ("VERIFY_AND_CHANGE_EMAIL" === o.requestType ? o.email : o.newEmail) || null,
                                    multiFactorInfo: d
                                },
                                operation: c
                            }
                        }
                        async function _t(e, code) {
                            const {
                                data: data
                            } = await vt(Object(r.q)(e), code);
                            return data.email
                        }
                        async function yt(e, t, n) {
                            const r = be(e),
                                ...
                                c = await Je._fromIdTokenResponse(r, "signIn", o);
                            return await r._updateCurrentUser(c.user), c
                        }

                        function It(e, t, n) {
                            return ot(Object(r.q)(e), je.credential(t, n))
                        }
                        async function wt(e, t, n) {
                            ...
                            S(n.handleCodeInApp, o, "argument-error"), n && pt(o, c, n), await async function(e, t) {
                                return Pe(e, t)
                            }(o, c)
                        }
                        ...
                        async function Tt(e, t, n) {
                            const o = Object(r.q)(e),
                                c = je.credentialWithLink(t, n || L());
                            return S(c._tenantId === (o.tenantId || null), o, "tenant-id-mismatch"), ot(o, c)
                        }
                        async function kt(e, t) {
                            const n = {
                                    identifier: t,
                                    continueUri: D() ? L() : "http://localhost"
                                },
                                {
                                    signinMethods: o
                                } = await async function(e, t) {
                                    return z(e, "POST", "/v1/accounts:createAuthUri", W(e, t))
                                }(Object(r.q)(e), n);
                            return o || []
                        }
                        async function Et(e, t) {
                        ...
                        async function Ot(e, {
                            ...
                            const o = Object(r.q)(e),
                                ...
                                d = await Q(o, async function(e, t) {
                                    return z(e, "POST", "/v1/accounts:update", t)
                                }(o.auth, c));
                            o.displayName = d.displayName || null, o.photoURL = d.photoUrl || null;
                            const l = o.providerData.find((({
                                providerId: e
                            }) => "password" === e));
                            l && (l.displayName = o.displayName, l.photoURL = o.photoURL), await o._updateTokensIfNecessary(d)
                        }

                        function St(e, t) {
                            return Pt(Object(r.q)(e), t, null)
                        }

                        function At(e, t) {
                            return Pt(Object(r.q)(e), null, t)
                        }
                        async function Pt(e, t, n) {
                            ...
                            const c = await Q(e, Ae(r, o));
                            await e._updateTokensIfNecessary(c, !0)
                        }
                        class Nt {
                            constructor(e, t, n = {}) {
                        ...
                        function jt(e) {
                            ...
                            return t.isAnonymous && !n ? {
                                ...
                                const {
                                    providerId: r
                                } = e, o = e.rawUserInfo ? JSON.parse(e.rawUserInfo) : {}, c = e.isNewUser || "identitytoolkit#SignupNewUserResponse" === e.kind;
                                if (!r && (null == e ? void 0 : e.idToken)) {
                                    const r = null === (n = null === (t = X(e.idToken)) || void 0 === t ? void 0 : t.firebase) || void 0 === n ? void 0 : n.sign_in_provider;
                                    if (r) return new Nt(c, "anonymous" !== r && "custom" !== r ? r : null)
                                }
                                if (!r) return null;
                                switch (r) {
                                    case "facebook.com":
                                    ...
                                    case "google.com":
                                        return new Mt(c, o);
                                    case "twitter.com":
                                        return new Ut(c, o, e.screenName || null);
                                    case "custom":
                                    case "anonymous":
                        ...
                        class Ft {
                            ...
                            static _fromIdtoken(e, t) {
                                return new Ft("enroll", e, t)
                            }
                            static _fromMfaPendingCredential(e) {
                                return new Ft("signin", e)
                            }
                            toJSON() {
                                return {
                                    multiFactorSession: {
                            ...
                            static fromJSON(e) {
                                ...
                                if (null == e ? void 0 : e.multiFactorSession) {
                                    if (null === (t = e.multiFactorSession) || void 0 === t ? void 0 : t.pendingCredential) return Ft._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);
                                    if (null === (n = e.multiFactorSession) || void 0 === n ? void 0 : n.idToken) return Ft._fromIdtoken(e.multiFactorSession.idToken)
                                }
                                return null
                            }
                        }
                        class xt {
                            ...
                            static _fromError(e, t) {
                                const n = be(e),
                                    ...
                                    o = (r.mfaInfo || []).map((e => lt._fromServerResponse(n, e)));
                                S(r.mfaPendingCredential, n, "internal-error");
                                const c = Ft._fromMfaPendingCredential(r.mfaPendingCredential);
                                return new xt(c, o, (async e => {
                                    const o = await e._process(n, c);
                                    delete r.mfaInfo, delete r.mfaPendingCredential;
                                    const d = Object.assign(Object.assign({}, r), {
                                        idToken: o.idToken,
                                        refreshToken: o.refreshToken
                                    });
                                    switch (t.operationType) {
                                        case "signIn":
                                            const e = await Je._fromIdTokenResponse(n, t.operationType, d);
                                            return await n._updateCurrentUser(e.user), e;
                                        case "reauthenticate":
                                            return S(t.user, n, "internal-error"), Je._forOperation(t.user, t.operationType, d);
                                        default:
                                            T(n, "internal-error")
                                    }
                                }))
                        ...
                        function Vt(e, t) {
                            ...
                            const o = Object(r.q)(e),
                                c = t;
                            return S(t.customData.operationType, o, "argument-error"), S(null === (n = c.customData._serverResponse) || void 0 === n ? void 0 : n.mfaPendingCredential, o, "argument-error"), xt._fromError(o, c)
                        }
                        class qt {
                            constructor(e) {
                            ...
                            async getSession() {
                                return Ft._fromIdtoken(await this.user.getIdToken(), this.user.auth)
                            }
                            async enroll(e, t) {
                                const n = e,
                                    r = await this.getSession(),
                                    o = await Q(this.user, n._process(this.user.auth, r, t));
                                return await this.user._updateTokensIfNecessary(o), this.user.reload()
                            }
                            async unenroll(e) {
                                const t = "string" == typeof e ? e : e.uid,
                                    n = await this.user.getIdToken();
                                try {
                                    const e = await Q(this.user, (r = this.user.auth, o = {
                                        idToken: n,
                                        mfaEnrollmentId: t
                                    }, z(r, "POST", "/v2/accounts/mfaEnrollment:withdraw", W(r, o))));
                        ...
                        function zt(e) {
                            const t = Object(r.q)(e);
                            return Wt.has(t) || Wt.set(t, qt._fromUser(t)), Wt.get(t)
                        }
                        const Ht = "__sak";
                        class Gt {
                            constructor(e, t) {
                            ...
                            _isAvailable() {
                                try {
                                    return this.storage ? (this.storage.setItem(Ht, "1"), this.storage.removeItem(Ht), Promise.resolve(!0)) : Promise.resolve(!1)
                                } catch (e) {
                        ...
                        class Kt extends Gt {
                            constructor() {
                                ...
                                }(), this.fallbackToPolling = _e(), this._shouldAllowMigration = !0
                            }
                            forAllChangedKeys(e) {
                            ...
                            onStorageEvent(e, t = !1) {
                                ...
                                const o = () => {
                                    ...
                                    c = this.storage.getItem(n);
                                Object(r.v)() && 10 === document.documentMode && c !== e.newValue && e.newValue !== e.oldValue ? setTimeout(o, 10) : o()
                            }
                            notifyListeners(e, t) {
                                this.localCache[e] = t;
                        ...
                        class Yt {
                            ...
                            async handleEvent(e) {
                                ...
                                const c = Array.from(o).map((async e => e(t.origin, data))),
                                    d = await
                                function(e) {
                                        ...
                                        onMessage(e) {
                                            ...
                                            if (t.data.eventId === l) switch (t.data.status) {
                                                case "ack":
                                                    ...
                                                    break;
                                                case "done":
                                                    clearTimeout(r), c(t.data.response);
                                                    break;
                                                default:
                                                    clearTimeout(h), clearTimeout(r), d(new Error("invalid_response"))
                                            }
                                        }
                        ...
                        function en() {
                            return void 0 !== Zt().WorkerGlobalScope && "function" == typeof Zt().importScripts
                        }
                        ...
                        function cn() {
                            ...
                            return new Promise(((t, n) => {
                                e.addEventListener("error", (() => {
                                    ...
                                    const n = e.result;
                                    n.objectStoreNames.contains(rn) ? t(n) : (n.close(), await
                                        function() {
                                            const e = indexedDB.deleteDatabase(tn);
                        ...
                        class ln {
                            ...
                            async initializeReceiver() {
                                this.receiver = Yt._getInstance(en() ? self : null), this.receiver._subscribe("keyChanged", (async (e, data) => ({
                                    keyProcessed: (await this._poll()).includes(data.key)
                            ...
                            async _isAvailable() {
                                try {
                                    ...
                                    const e = await cn();
                                    return await un(e, Ht, "1"), await dn(e, Ht), !0
                                } catch (e) {}
                                return !1
                            }
                            ...
                            async _set(e, t) {
                                return this._withPendingWrite((async () => (await this._withRetries((n => un(n, e, t))), this.localCache[e] = t, this.notifyServiceWorker(e))))
                            }
                            async _get(e) {
                                const t = await this._withRetries((t => async function(e, t) {
                                    const n = an(e, !1).get(t),
                                        data = await new on(n).toPromise();
                                    return void 0 === data ? null : data.value
                                }(t, e)));
                                return this.localCache[e] = t, t
                            }
                            async _remove(e) {
                                return this._withPendingWrite((async () => (await this._withRetries((t => dn(t, e))), delete this.localCache[e], this.notifyServiceWorker(e))))
                            }
                            async _poll() {
                                ...
                                for (const {
                                        fbase_key: r,
                                        value: o
                                    } of e) n.add(r), JSON.stringify(this.localCache[r]) !== JSON.stringify(o) && (this.notifyListeners(r, o), t.push(r));
                        ...
                        function pn(e) {
                            return new Promise(((t, n) => {
                                ...
                                r.setAttribute("src", e), r.onload = t, r.onerror = e => {
                                    const t = k("internal-error");
                                    t.customData = e, n(t)
                                }, r.type = "text/javascript", r.charset = "UTF-8", (null !== (c = null === (o = document.getElementsByTagName("head")) || void 0 === o ? void 0 : o[0]) && void 0 !== c ? c : document).appendChild(r)
                            }))
                        }
                        ...
                        class gn {
                            constructor(e) {
                                this.auth = e, this.counter = mn, this._widgets = new Map
                            }
                            render(e, t) {
                                const n = this.counter;
                                return this._widgets.set(n, new vn(e, this.auth.name, t || {})), this.counter++, n
                            }
                            reset(e) {
                                var t;
                                const n = e || mn;
                        ...
                        class In {
                            constructor() {
                                var e;
                                this.hostLanguage = "", this.counter = 0, this.librarySeparatelyLoaded = !!(null === (e = Zt().grecaptcha) || void 0 === e ? void 0 : e.render)
                            }
                            load(e, t = "") {
                                return S(function(e) {
                                    return e.length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(e)
                                }(t), e, "argument-error"), this.shouldResolveImmediately(t) ? Promise.resolve(Zt().grecaptcha) : new Promise(((n, o) => {
                                    const c = Zt().setTimeout((() => {
                                        o(k(e, "network-request-failed"))
                                    }), yn.get());
                                    Zt()[_n] = () => {
                                        Zt().clearTimeout(c), delete Zt()[_n];
                                        const r = Zt().grecaptcha;
                                        if (!r) return void o(k(e, "internal-error"));
                                        const d = r.render;
                                        r.render = (e, t) => {
                                            const n = d(e, t);
                                    ...
                                    pn(`https://www.google.com/recaptcha/api.js??${Object(r.B)({onload:_n,render:"explicit",hl:t})}`).catch((() => {
                                        clearTimeout(c), o(k(e, "internal-error"))
                                    }))
                                }))
                            }
                            clearedOneInstance() {
                            ...
                            shouldResolveImmediately(e) {
                                var t;
                                return !!(null === (t = Zt().grecaptcha) || void 0 === t ? void 0 : t.render) && (e === this.hostLanguage || this.counter > 0 || this.librarySeparatelyLoaded)
                            }
                        }
                        class wn {
                            async load(e) {
                        ...
                        class kn {
                            constructor(e, t = Object.assign({}, Tn), n) {
                                this.parameters = t, this.type = bn, this.destroyed = !1, this.widgetId = null, this.tokenChangeListeners = new Set, this.renderPromise = null, this.recaptcha = null, this.auth = be(n), this.isInvisible = "invisible" === this.parameters.size, S("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment");
                                const r = "string" == typeof e ? document.getElementById(e) : e;
                                S(r, this.auth, "argument-error"), this.container = r, this.parameters.callback = this.makeTokenCallback(this.parameters.callback), this._recaptchaLoader = this.auth.settings.appVerificationDisabledForTesting ? new wn : new In, this.validateStartingState()
                            }
                            async verify() {
                            ...
                            validateStartingState() {
                                S(!this.parameters.sitekey, this.auth, "argument-error"), S(this.isInvisible || !this.container.hasChildNodes(), this.auth, "argument-error"), S("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment")
                            }
                            makeTokenCallback(e) {
                                return t => {
                            ...
                            async init() {
                                S(D() && !en(), this.auth, "internal-error"), await
                                function() {
                                    let e = null;
                                ...
                                const e = await async function(e) {
                                    return (await z(e, "GET", "/v1/recaptchaParams")).recaptchaSiteKey || ""
                                }(this.auth);
                        ...
                        class En {
                            ...
                            confirm(e) {
                                const t = Me._fromVerification(this.verificationId, e);
                                return this.onConfirmation(t)
                            }
                        }
                        async function Rn(e, t, n) {
                            const o = be(e),
                                c = await An(o, t, Object(r.q)(n));
                            return new En(c, (e => ot(o, e)))
                        }
                        async function On(e, t, n) {
                            const o = Object(r.q)(e);
                            await nt(!1, o, "phone");
                            const c = await An(o.auth, t, Object(r.q)(n));
                            return new En(c, (e => at(o, e)))
                        }
                        async function Sn(e, t, n) {
                            const o = Object(r.q)(e),
                                c = await An(o.auth, t, Object(r.q)(n));
                            return new En(c, (e => ct(o, e)))
                        }
                        async function An(e, t, n) {
                            var r;
                            const o = await n.verify();
                            try {
                                let c;
                                if (S("string" == typeof o, e, "argument-error"), S(n.type === bn, e, "argument-error"), c = "string" == typeof t ? {
                                        phoneNumber: t
                                    } : t, "session" in c) {
                                    const t = c.session;
                                    if ("phoneNumber" in c) {
                                        ...
                                        const n = await
                                        function(e, t) {
                                            return z(e, "POST", "/v2/accounts/mfaEnrollment:start", W(e, t))
                                        }(e, {
                                        ...
                                        const n = (null === (r = c.multiFactorHint) || void 0 === r ? void 0 : r.uid) || c.multiFactorUid;
                                        S(n, e, "missing-multi-factor-info");
                                        const d = await
                                        function(e, t) {
                                            return z(e, "POST", "/v2/accounts/mfaSignIn:start", W(e, t))
                                        }(e, {
                                        ...
                                        return d.phoneResponseInfo.sessionInfo
                                    }
                                } {
                                    const {
                                        sessionInfo: t
                                    } = await async function(e, t) {
                                        return z(e, "POST", "/v1/accounts:sendVerificationCode", W(e, t))
                                    }(e, {
                                        phoneNumber: c.phoneNumber,
                                        recaptchaToken: o
                                    });
                        ...
                        async function Pn(e, t) {
                            await tt(Object(r.q)(e), t)
                        }
                        class Nn {
                            constructor(e) {
                                this.providerId = Nn.PROVIDER_ID, this.auth = be(e)
                            }
                            verifyPhoneNumber(e, t) {
                                return An(this.auth, e, Object(r.q)(t))
                            }
                            static credential(e, t) {
                                return Me._fromVerification(e, t)
                            }
                            static credentialFromResult(e) {
                                const t = e;
                            ...
                            static credentialFromTaggedObject({
                                ...
                                return t && n ? Me._fromTokenResponse(t, n) : null
                            }
                        }

                        function Cn(e, t) {
                            return t ? C(t) : (S(e._popupRedirectResolver, e, "argument-error"), e._popupRedirectResolver)
                        }
                        Nn.PROVIDER_ID = "phone", Nn.PHONE_SIGN_IN_METHOD = "phone";
                        class Ln extends Oe {
                            constructor(e) {
                                super("custom", "custom"), this.params = e
                            }
                            _getIdTokenResponse(e) {
                                return Ce(e, this._buildIdpRequest())
                            }
                            _linkToIdToken(e, t) {
                                return Ce(e, this._buildIdpRequest(t))
                            }
                            _getReauthenticationResolver(e) {
                                return Ce(e, this._buildIdpRequest())
                            }
                        ...
                        function Dn(e) {
                            return st(e.auth, new Ln(e), e.bypassAuthState)
                        }
                        ...
                        function Mn(e) {
                            ...
                            return S(n, t, "internal-error"), it(n, new Ln(e), e.bypassAuthState)
                        }
                        async function Un(e) {
                            const {
                                auth: t,
                            ...
                            return S(n, t, "internal-error"), tt(n, new Ln(e), e.bypassAuthState)
                        }
                        class jn {
                            constructor(e, filter, t, n, r = !1) {
                                this.auth = e, this.resolver = t, this.user = n, this.bypassAuthState = r, this.pendingPromise = null, this.eventManager = null, this.filter = Array.isArray(filter) ? filter : [filter]
                            }
                            execute() {
                            ...
                            async onAuthEvent(e) {
                                ...
                                try {
                                    this.resolve(await this.getIdpTask(d)(l))
                                } catch (e) {
                                    this.reject(e)
                                }
                            }
                        ...
                        const Fn = new U(2e3, 1e4);
                        async function xn(e, t, n) {
                            const r = be(e);
                            R(e, t, Fe);
                            const o = Cn(r, n);
                            return new Wn(r, "signInViaPopup", t, o).executeNotNull()
                        }
                        async function Vn(e, t, n) {
                            const o = Object(r.q)(e);
                            R(o.auth, t, Fe);
                            const c = Cn(o.auth, n);
                            return new Wn(o.auth, "reauthViaPopup", t, c, o).executeNotNull()
                        }
                        async function qn(e, t, n) {
                            const o = Object(r.q)(e);
                            R(o.auth, t, Fe);
                            const c = Cn(o.auth, n);
                            return new Wn(o.auth, "linkViaPopup", t, c, o).executeNotNull()
                        }
                        class Wn extends jn {
                            constructor(e, filter, t, n, r) {
                                super(e, filter, n, r), this.provider = t, this.authWindow = null, this.pollId = null, Wn.currentPopupAction && Wn.currentPopupAction.cancel(), Wn.currentPopupAction = this
                            }
                            ...
                            async onExecution() {
                                P(1 === this.filter.length, "Popup operations only handle one event");
                                const e = Xt();
                                this.authWindow = await this.resolver._openPopup(this.auth, this.provider, this.filter[0], e), this.authWindow.associatedEvent = e, this.resolver._originValidation(this.auth).catch((e => {
                                    ...
                                    e || this.reject(k(this.auth, "web-storage-unsupported"))
                            ...
                            cancel() {
                                this.reject(k(this.auth, "cancelled-popup-request"))
                            }
                            cleanUp() {
                            ...
                            pollUserCancellation() {
                                const e = () => {
                                    ...
                                    (null === (n = null === (t = this.authWindow) || void 0 === t ? void 0 : t.window) || void 0 === n ? void 0 : n.closed) ? this.pollId = window.setTimeout((() => {
                                        this.pollId = null, this.reject(k(this.auth, "popup-closed-by-user"))
                                    }), 2e3): this.pollId = window.setTimeout(e, Fn.get())
                                };
                                e()
                            }
                        }
                        Wn.currentPopupAction = null;
                        const zn = "pendingRedirect",
                            Hn = new Map;
                        class Gn extends jn {
                            constructor(e, t, n = !1) {
                            ...
                            async execute() {
                                ...
                                if (!e) {
                                    ...
                                    Hn.set(this.auth._key(), e)
                                }
                                return this.bypassAuthState || Hn.set(this.auth._key(), (() => Promise.resolve(null))), e()
                            }
                            async onAuthEvent(e) {
                        ...
                        function $n(e) {
                            return ae(zn, e.config.apiKey, e.name)
                        }

                        function Yn(e, t, n) {
                            return async function(e, t, n) {
                                const r = be(e);
                                R(e, t, Fe), await r._initializationPromise;
                                const o = Cn(r, n);
                                return await Kn(o, r), o._openRedirect(r, t, "signInViaRedirect")
                            }(e, t, n)
                        }
                        ...
                        function Xn(e, t, n) {
                            return async function(e, t, n) {
                                const o = Object(r.q)(e);
                                R(o.auth, t, Fe), await o.auth._initializationPromise;
                                const c = Cn(o.auth, n);
                                await Kn(c, o.auth);
                                const d = await ti(o);
                                return c._openRedirect(o.auth, t, "reauthViaRedirect", d)
                            }(e, t, n)
                        }
                        ...
                        function Qn(e, t, n) {
                            return async function(e, t, n) {
                                ...
                                R(o.auth, t, Fe), await o.auth._initializationPromise;
                                const c = Cn(o.auth, n);
                                await nt(!1, o, t.providerId), await Kn(c, o.auth);
                                const d = await ti(o);
                                return c._openRedirect(o.auth, t, "linkViaRedirect", d)
                            }(e, t, n)
                        }
                        async function Zn(e, t) {
                            return await be(e)._initializationPromise, ei(e, t, !1)
                        }
                        async function ei(e, t, n = !1) {
                            const r = be(e),
                                ...
                                c = new Gn(r, o, n),
                                d = await c.execute();
                            return d && !n && (delete d.user._redirectEventId, await r._persistUserIfCurrent(d.user), await r._setRedirectUser(null, t)), d
                        }
                        async function ti(e) {
                            const t = Xt(`${e.uid}:::`);
                        ...
                        class ni {
                            ...
                            sendToConsumer(e, t) {
                                var n;
                                if (e.error && !ri(e)) {
                                    const code = (null === (n = e.error.code) || void 0 === n ? void 0 : n.split("auth/")[1]) || "internal-error";
                                    t.onError(k(this.auth, code))
                            ...
                            hasEventBeenHandled(e) {
                                return Date.now() - this.lastProcessedEventTime >= 6e5 && this.cachedEventUids.clear(), this.cachedEventUids.has(ii(e))
                            }
                            saveEventToCache(e) {
                                this.cachedEventUids.add(ii(e)), this.lastProcessedEventTime = Date.now()
                            }
                        }
                        ...
                        function ci(e) {
                            ...
                            if (e.startsWith("chrome-extension://")) {
                                const o = new URL(e);
                                return "" === o.hostname && "" === r ? "chrome-extension:" === n && e.replace("chrome-extension://", "") === t.replace("chrome-extension://", "") : "chrome-extension:" === n && o.hostname === r
                            }
                            if (!ai.test(n)) return !1;
                            if (oi.test(e)) return r === e;
                            const o = e.replace(/\./g, "\\.");
                            return new RegExp("^(.+\\." + o + "|" + o + ")$", "i").test(r)
                        }
                        const ui = new U(3e4, 6e4);
                            ...
                            if (null == e ? void 0 : e.H)
                                for (const t of Object.keys(e.H))
                                    if (e.H[t].r = e.H[t].r || [], e.H[t].L = e.H[t].L || [], e.H[t].r = [...e.H[t].L], e.CP)
                                        for (let i = 0; i < e.CP.length; i++) e.CP[i] = null
                        }
                        let hi = null;
                                ...
                                return new Promise(((t, n) => {
                                    ...
                                    function d() {
                                        di(), gapi.load("gapi.iframes", {
                                            ...
                                            ontimeout: () => {
                                                di(), n(k(e, "network-request-failed"))
                                            },
                                            timeout: ui.get()
                                        })
                                    }
                                    if (null === (o = null === (r = Zt().gapi) || void 0 === r ? void 0 : r.iframes) || void 0 === o ? void 0 : o.Iframe) t(gapi.iframes.getContext());
                                    else {
                                        if (!(null === (c = Zt().gapi) || void 0 === c ? void 0 : c.load)) {
                                            const t = fn("iframefcb");
                                            return Zt()[t] = () => {
                                                gapi.load ? d() : n(k(e, "network-request-failed"))
                                            }, pn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e => n(e)))
                                        }
                                        d()
                                    }
                                })).catch((e => {
                        ...
                        function yi(e) {
                            ...
                            const n = t.emulator ? j(t, gi) : `https://${e.config.authDomain}/${mi}`,
                                c = {
                                    apiKey: t.apiKey,
                                    appName: e.name,
                                    v: o.SDK_VERSION
                                },
                                d = _i.get(e.config.apiHost);
                            d && (c.eid = d);
                            const l = e._getFrameworks();
                            return l.length && (c.fw = l.join(",")), `${n}?${Object(r.B)(c).slice(1)}`
                        }
                        const Ii = {
                                location: "yes",
                                resizable: "yes",
                        ...
                        function Ri(e, t, n, o = wi, c = bi) {
                            ...
                            n && (h = he(m) ? Ti : n), de(m) && (t = t || ki, f.scrollbars = "yes");
                            const v = Object.entries(f).reduce(((e, [t, n]) => `${e}${t}=${n},`), "");
                            if (function(e = Object(r.r)()) {
                                    var t;
                                    return ve(e) && !!(null === (t = window.navigator) || void 0 === t ? void 0 : t.standalone)
                                }(m) && "_self" !== h) return function(e, t) {
                                const n = document.createElement("a");
                                n.href = e, n.target = t;
                                const r = document.createEvent("MouseEvent");
                                r.initMouseEvent("click", !0, !0, window, 1, 0, 0, 0, 0, !1, !1, !1, !1, 1, null), n.dispatchEvent(r)
                            }(t || "", h), new Ei(null);
                            const _ = window.open(t || "", h, v);
                            S(_, e, "popup-blocked");
                            try {
                                _.focus()
                            } catch (e) {}
                        ...
                        const Oi = "__/auth/handler",
                            Si = "emulator/auth/handler";

                        function Ai(e, t, n, c, d, l) {
                            ...
                            if (t instanceof Fe) {
                                t.setDefaultLanguage(e.languageCode), h.providerId = t.providerId || "", Object(r.u)(t.getCustomParameters()) || (h.customParameters = JSON.stringify(t.getCustomParameters()));
                                for (const [e, t] of Object.entries(l || {})) h[e] = t
                            }
                            if (t instanceof xe) {
