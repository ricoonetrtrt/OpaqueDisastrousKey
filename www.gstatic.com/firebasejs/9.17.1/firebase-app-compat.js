! function(e, t) {
    ...
    function H(n) {
        return n !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (P = P || [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey]).includes(n) ? function(...e) {
    ...
    function x(e) {
        ...
        }), R.set(i, t))), B(e, T = T || [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]) ? new Proxy(e, j) : e);
        var i, t
    }
    ...
    q = "", ae(new v("platform-logger", e => new K(e), "PRIVATE")), ae(new v("heartbeat", e => new ye(e), "PRIVATE")), de(Y, "0.9.3", q), de(Y, "0.9.3", "esm2017"), de("fire-js", "");
